...
- [ovh/terraform-provider-ovh](https://github.com/ovh/terraform-provider-ovh) ([v2.9.0](https://github.com/ovh/terraform-provider-ovh/releases/tag/v2.9.0), 2 days ago) - Terraform OVH provider
...
- [CachyOS/linux-cachyos](https://github.com/CachyOS/linux-cachyos) - Archlinux Kernel based on different schedulers and some other performance improvements. (4 days ago)
- [basecamp/omarchy](https://github.com/basecamp/omarchy) - Beautiful, Modern &amp; Opinionated Linux (4 days ago)
- [plankanban/planka](https://github.com/plankanban/planka) - PLANKA is the kanban-style project mastering tool for everyone. (4 days ago)
- [moabukar/CKS-Exercises-Certified-Kubernetes-Security-Specialist](https://github.com/moabukar/CKS-Exercises-Certified-Kubernetes-Security-Specialist) - A set of curated exercises to help you prepare for the CKS exam (6 days ago)
